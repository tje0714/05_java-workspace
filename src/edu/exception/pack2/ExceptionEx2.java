...
public class ExceptionEx2 {
     ...
     *
     * case 1 에서 문제가 발생할 경우 break를 작성하지 않아도
        ...
        while (true){
            ...
            switch (choice) {
                ...
                Exception in thread "main" java.lang.ClassCastException
                    at edu.exception.pack2.ExceptionEx2.method1(ExceptionEx2.java:39)
...
case 1:
        ...
        break;  // 또 멈춘다고 ?!   멈춘 다음 또 다시 돌아와 멈춤 기능을 진행한다와 같음

        break를 두 번 작성한 것과 비슷한 효과를 가짐!!!
    * */
    public void method2(){
        Scanner sc = new Scanner(System.in);
    ...
    public void method3(){
        ...
        } catch (Exception e) { // 맨 위에 Exception을 작성하면 모든예외가 이곳에서 출력되기 때문에
            // 아래 catch 구문으로 예외상황에 따른 대응을 작성하더라도 대응 처리를 하지 못하기 때문에
            // 맨 아래에 작성하는 것
            System.out.println("예외는 어떤 예외들이 뜨는지 확인 후 154번 줄 위에" +
