...
public class ArrayEx2 {
    ...
    public void method1() {
        ...
        int[] arr2 = arr1; // arr2 는 arr1 의 주소만 복사해서 값 가져오기 바로가기
    ...
    public void method2(){
        ...
        System.out.println("===== 복사 후 각 array의 length 의 값 =====");
        System.out.println("arr1의 length : " + arr1.length);
        System.out.println("arr2의 length : " + arr2.length);
        System.out.println("arr3의 length : " + arr3.length);
        ...
        System.arraycopy(arr1          , 0                         , arr3            , 0                            , arr1.length);
                         원본배열변수이름, 원복 복사를 시작할 인덱스 위치  복사해놓을 배열 이름, 복사 배열의 삽입 시작할 인덱스 위치,복사할 총 길이);
         */
        System.arraycopy(arr1, 0, arr3, 0, arr1.length);
