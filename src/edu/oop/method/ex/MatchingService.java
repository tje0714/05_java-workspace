...
public class MatchingService {
    ...
    private void updateMemberDetails() {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                m.setJob(memberJob);
                System.out.println("직업을 성공적으로 변경되었습니다.");
                break;
            default:
    ...
    public boolean checkAgeValid() {
        // this. MatchingMember 에서는 private 으로 가리키고 있는 필드 명칭
        // MatchingMember를 m이라는 변수명칭으로 호출
