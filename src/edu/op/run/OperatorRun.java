...
public class OperatorRun {
    // static 이 작성된 기능이나 변수이름 메모리에서 프로그램을 사용할 때 상시사용 처럼
    // 메모리공간을 차지하는 예약어
     ...
     * - 누군가 클래스로 만들어진 객체를 사용하면 보관, 사용하지 않으면 창고 공간을 차지하는 불필요한 객체
     *    나 기능으로 판단하여 버림
    ...
    public static void main(String[] args) {
        ...
        // 가져와서 OperatorRun 클래스 내부에 서 사용할 때
        // op 별칭을 붙여준 후 사용
        // 기존에 어떤 개발자가 만들어놓은 파일을가져와서
        // 파일에 작성된 기능이나 변수값활용해서 코딩하려해
        // new OperatorEx().test();
