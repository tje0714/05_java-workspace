public class VariableEx1 {
    ...
    public  static void main(String[] args){
        ...
        [문자형]
        char    (2byte)     - 문자 하나, 문자 양옆에 '' 작 은 따 옴 표 사용
        ...
        // byte short int long 은 모두 값(=리터럴)에서 뒤에 자료형 명칭이 붙지 않는한 모두 int
        ...
        *           그런데 nt2에 2배가량이 넘는 long 데이터 를 담아 넣으려 하기 때문에
        ...
        * */
        int nt1 = 100;
        int nt2 = (int)100000000000L; // long 데이터가 int 로 강제 형변환  데이터 변질
